...
#--4th row--# Square root of a number
...
equal = Button(tk_calc, button_params_main, text='=',
               command=button_equal).grid(row=9, columnspan=3, column=3, sticky="nsew")
